...
'''
Implement the basic logic operation layer (conjunction and disjunction).
'''
...
'''
Implement the logical reasoning process of Disjunctive Normal Form (DNF).
'''
class DNF(nn.Module):
...
'''
Used to control the decay of delta, so that the delta value can be dynamically adjusted during training.
'''
