...
class Config:
    ...
    # train_data_file = r'/home/s1022244043/wyj/data/cognitive/train_simp_cleaned_0708_13+0.2neg-summary.jsonl'
    # test_data_file = '/home/s1022244043/wyj/data/cognitive/test_simp_cleaned_0708_13.jsonl'
    # val_data_file = '/home/s1022244043/wyj/data/cognitive/val_simp_cleaned_0708_13+0.2neg-summary.jsonl'


    train_data_file = r'/home/s1022244043/wyj/data/cognitive/train_simp_cleaned_0708_13+0.4neg-summary.jsonl'
    test_data_file = '/home/s1022244043/wyj/data/cognitive/test_simp_cleaned_0708_13.jsonl'
    val_data_file = '/home/s1022244043/wyj/data/cognitive/val_simp_cleaned_0708_13+0.4neg-summary.jsonl'
...
tokenizer = BertTokenizer.from_pretrained('/home/s1022244043/wyj/Trust_TELLER-main-109/chinese-roberta-wwm-ext')
bert_model = RobertaModel.from_pretrained('/home/s1022244043/wyj/Trust_TELLER-main-109/chinese-roberta-wwm-ext').eval()
...
class HGTModel(nn.Module):
    ...
    def forward(self, x_dict, edge_index_dict):
        ...
        return self.classifier(x_dict['news'])
...
def main():
    ...
    # 预测并保存attention
    # predict(model, test_loader, 'hgt_attentions_dynamic_evidence_tuning.jsonl')
