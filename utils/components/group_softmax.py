...
class GSBBoxHeadWith0(SharedFCBBoxHead):
    ...
    def __init__(self,
        ...
        # 所以是两阶段，从文件路径 gs_config.pred_slice 中加载一个 PyTorch 张量（tensor）。gs_config.pred_slice 是一个配置文件路径，通常是一个 .pt 或 .pth 文件，存储了预先定义好的切片信息
    ...
    def _merge_score(self, cls_score):
        ...
        with the score of fg（foreground）.
        From v1.
        '''
